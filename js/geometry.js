function createVertexPositions(func, count) {
    count += 1;
    const instancePositions = new Float32Array(count * 3);

    for (let i = 0; i < count; i++) {
        let p = func(i / (count - 1));
...
function createEdgePositions(pointsArray) {
...
function createInstancedGeometry(geometry, positions) {
